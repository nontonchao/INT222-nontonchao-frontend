...
const login = async () => {
  ...
  if (loginStore.resStatus !== 401) {
    ...
    localStorage.setItem("refresh_token", loginStore.token_obj.refresh_token);
  ...
  <div>
    <section class="py-4 py-xl-5">
      ...
      <section class="container py-4 py-xl-5">
        <div class="row mb-5 p-4 p-lg-5">
          <div class="col-md-8 col-xl-6 text-center mx-auto pt-3" v-show="loginStore.resToken == 401">
            <div class="icon-box">
            ...
            <br />
            <h2 class="fw-bold">ขอโทษที</h2>
            <p class="w-lg-50">
              ดูเหมือนว่าคุณจะเข้าใช้ระบบนานเกินไป
              กรุณาลงชื่อเข้าใช้ใหม่เพื่อ<br />เข้าถึงบริการ OASIP-SY1 by NTC
              <br />
            </p>
          </div>
          <div class="col-md-8 col-xl-6 text-center mx-auto pt-3" v-show="loginStore.resToken != 401">
                ...
                <div class="col-md-8 col-lg-6 col-xl-5 col-xxl-5">
                  <div class="card mb-5 border-0">
                    <div class="card-body p-sm-5">
                      <div class="mb-3">
                        <input v-model="email" @keyup="ValidateEmail(email)" class="form-control" type="email"
                          id="email-2" name="email" placeholder="อีเมล" />
                      </div>
                      <div class="mb-5">
                      ...
                      <div class="text-center">
                        <button @click="login(), loginStore.resToken = 0" class="btn btn-danger btn-sm mx-4"
                          type="button" style="--bs-btn-border-radius: 1rem" data-bs-toggle="modal"
                          data-bs-target="#loginModal" :disabled="
                            password.length < 8 ||
    ...
    <div id="loginModal" class="modal fade">
      <div class="modal-dialog modal-confirm modal-lx modal-dialog-centered">
        <!--401,404  Modal HTML -->
        <div class="modal-content" v-show="loginStore.resStatus == 401 || loginStore.resStatus == 404">
        ...
        <div class="modal-content" v-show="loginStore.resStatus == 200">
          <div class="modal-header flex-column">
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true" @click="
              loginStore.resStatus = 0;
              router.push(`/`);
            "></button>
            <div class="icon-box">
              <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor"
