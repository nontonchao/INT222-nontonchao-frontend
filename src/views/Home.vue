...
<template>
  ...
  <div>
      ...
      <div class="container">
        <div class="text-center p-4 p-lg-5">
          <h1 class="fw-bold mb-4 display-5" style="margin: 125px">
            Online Appointment <br />Scheduling System for<br />Integrated
            Project Clinics (OASIP)<br />
          </h1>
          ...
          <button class="btn btn-danger fs-5 me-2 py-2 px-4" type="button" style="
            ...
            <router-link :to="{ name: 'AddEvent' }" style="text-decoration: none; color: #ffffff">
              จองนัดหมายเลย
            </router-link>
          </button>
        </div>
    ...
    <section class="py-4 py-xl-5">
      <div class="container py-4 py-xl-5" style="background: #ffffff">
        <div class="row mb-5">
          <div class="col-md-8 col-xl-6 text-center mx-auto">
            <h2 class="fw-bold display-3" style="font-size: 55px">Features</h2>
            <p class="w-lg-50">
              ประสบการณ์และสิ่งเจ๋งๆที่ OASIP-SY1 จะมอบให้คุณ
            </p>
          </div>
        </div>
        <div class="row gy-4 row-cols-1 row-cols-md-2 row-cols-xl-3">
            ...
            <div class="text-center d-flex flex-column align-items-center align-items-xl-center border-bottom"
              ...
              <div class="px-3">
                ...
                <p style="
                  ...
                  เพียงไม่กี่คลิกก็สามารถจองนัดหมายได้แล้ว<br />
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="text-center d-flex flex-column align-items-center align-items-xl-center border-bottom"
              ...
              <div class="px-3">
                ...
                <p style="
                    ...
                    padding-left: 0px;
                  ">
                  สามารถตรวจสอบการนัดหมายได้ ไม่ว่าจะเป็นการตรวจสอบทั้งหมด
                  การตรวจสอบ / ค้นหาจาก Email<br />
                </p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="text-center d-flex flex-column align-items-center align-items-xl-center border-bottom"
              ...
              <div
                class="bs-icon-lg bs-icon-rounded bs-icon-primary d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block mb-3 bs-icon lg">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="8 1 1 20">
                  <path
              ...
              <div class="px-3">
                ...
                <p style="
                    ...
                    padding-left: 0px;
                  ">
                  หากต้องการแก้ไขการนัดหมายก็สามารถทำได้เองโดยไม่ต้องยุ่งยาก<br />
                </p>
                <br />
              </div>
            </div>
        ...
        <div class="row gy-4 row-cols-1 row-cols-md-2 row-cols-xl-3">
          <div class="col">
            <div class="text-center d-flex flex-column align-items-center align-items-xl-center" style="padding: 30px">
              <div
                class="bs-icon-lg bs-icon-rounded bs-icon-primary d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block mb-3 bs-icon lg">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 20 20"
                  class="bi bi-bell">
              ...
              <div class="px-3">
                ...
                <p style="
                    ...
                    padding-left: 0px;
                  ">
                  หากนัดหมายไปแล้วไม่สะดวก
                  หรือต้องการยกเลิกนัดหมายก็สามารถทำได้เลย<br />
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="text-center d-flex flex-column align-items-center align-items-xl-center" style="padding: 30px">
              ...
              <div class="px-3">
                ...
                <p style="
                    ...
                    padding-left: 0px;
                  ">
                  อัพเดทข้อมูลเรียลไทม์ตลอด หลีกเลี่ยงปัญหาการจองซ้อนทับกัน<br />
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="text-center d-flex flex-column align-items-center align-items-xl-center" style="padding: 30px">
              ...
              <div class="px-3">
                ...
                <p style="
                    ...
                    padding-left: 0px;
                  ">
                  สามารถแก้ไขชื่อหมวดหมู่
                  และระยะเวลาในการนัดหมายได้ตามที่ต้องการ<br />
                </p>
              </div>
            </div>
          </div>
